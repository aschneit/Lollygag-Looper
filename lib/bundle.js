...
var AppView = __webpack_require__(2);
...
var AppView = function () {
  function AppView(ctx, canvas) {
    ...
    this.keysMute = $('.keys-mute');
    this.bassMute = $('.bass-mute');
    this.drumsMute = $('.drums-mute');
  }

  _createClass(AppView, [{
    key: "loopDrums",
    value: function loopDrums() {
      var _this = this;
      ...
      this.canvas.addEventListener('click', function (e) {
        ...
        var pos = {
          x: e.clientX - _this.left,
          y: e.clientY - _this.top
        };
        if (_this.isIntersection(pos, drums)) {
          var drumSound = _this.drums.createDrums();
          var drumLoop = new Tone.Loop(function (time) {
            drumSound.triggerAttackRelease('A1', '4n', time);
            var ctx = _this.ctx;
            ctx.fillStyle = 'red';
            ctx.beginPath();
            ctx.arc(100, 300, 50, 0, 2 * Math.PI, true);
            ctx.fill();
            setTimeout(function () {
              ctx.fillStyle = 'green';
              ctx.beginPath();
          ...
          _this.drumsMute.on('change', function (event) {
            if (_this.drumsMute.prop("checked")) {
              drumLoop.mute = true;
            } else {
              drumLoop.mute = false;
            }
          });
          if (!_this.drumsMute.prop("checked")) drumLoop.start(0);
          Tone.Transport.start('+0.1');
          _this.looping = true;

          _this.stopLoop(drumLoop);
        }
      });
    }
  }, {
    key: "animateBass",
    value: function animateBass(inputString) {
      var _this2 = this;

      var string = Object.assign({}, inputString);
      var firstY = string.y;
      var time = 0;
      var set = setInterval(function () {
        var amplitude = 4.5;
        var period = 2.5;
        var nextPos = amplitude * Math.sin(time * 2 * Math.PI / period) + string.y;
        _this2.ctx.strokeStyle = "orange";
        _this2.ctx.lineWidth = 7;
        _this2.ctx.beginPath();
        _this2.ctx.moveTo(string.xStart, string.y);
        _this2.ctx.lineTo(string.xEnd, string.y);
        _this2.ctx.stroke();
        string.y = nextPos;
        time += 1;
      ...
      setTimeout(function () {
        ...
        _this2.ctx.lineWidth = 5;
        _this2.ctx.beginPath();
        _this2.ctx.moveTo(string.xStart, firstY);
        _this2.ctx.lineTo(string.xEnd, firstY);
        _this2.ctx.stroke();
      }, 500);
    }
  }, {
    key: "animateKeys",
    value: function animateKeys(inputKey) {
      var key = Object.assign({}, inputKey);
      var ctx = this.ctx;
    ...
    value: function loopBass() {
      ...
      this.canvas.addEventListener('click', function (e) {
        ...
        var pos = {
          x: e.clientX - _this3.left,
          y: e.clientY - _this3.top
        };
        var firstString = {
        ...
        strings.forEach(function (string) {
          if (pos.x > string.xStart && pos.x < string.xEnd && pos.y > string.yStart && pos.y < string.yEnd) {
            ...
            var displace = Tone.Transport.seconds % (60 / Tone.Transport.bpm.value * 4);
            if (_this3.looping === true && !_this3.bassMute.prop("checked")) bassLoop.start(displace);
            _this3.stopLoop(bassLoop);
          }
        });
      });
    }
    ...
    value: function loopKeyboard() {
      ...
      this.canvas.addEventListener('click', function (e) {
        ...
        var pos = {
          x: e.clientX - _this4.left,
          y: e.clientY - _this4.top
        };
        var firstKey = {
        ...
        var keys = [firstKey, secondKey, thirdKey, fourthKey, fifthKey];

        var keyboardSound = _this4.keyboard.createKeyboard();
        keys.forEach(function (key) {
          if (pos.x > key.xStart && pos.x < key.xEnd && pos.y > key.yStart && pos.y < key.yEnd) {
            if (!_this4.keysMute.prop("checked")) {
              keyboardSound.triggerAttackRelease(key.note, '8n');
              _this4.animateKeys(key);
            }
            var keyboardLoop = new Tone.Loop(function (time) {
              keyboardSound.triggerAttackRelease(key.note, '8n', time);
              _this4.animateKeys(key);
            }, '1n');
            var displace = Tone.Transport.seconds % (60 / Tone.Transport.bpm.value * 4);
            if (_this4.looping === true && !_this4.keysMute.prop("checked")) keyboardLoop.start(displace);
            _this4.stopLoop(keyboardLoop);
            var keysMute = $('.keys-mute');
            _this4.keysMute.on('change', function (event) {
              if (_this4.keysMute.prop("checked")) {
    ...
    key: "isIntersection",
    value: function isIntersection(point, circle) {
    ...
    value: function preRecorded() {
      ...
      setTimeout(function () {
        e.clientX = 500 + _this7.left;
        e.clientY = 270 + _this7.top;
        if (_this7.looping) _this7.canvas.dispatchEvent(e);
      }, 150 / Tone.Transport.bpm.value * 5000);
      setTimeout(function () {
        e.clientX = 810 + _this7.left;
        e.clientY = 300 + _this7.top;
        if (_this7.looping) _this7.canvas.dispatchEvent(e);
      }, 150 / Tone.Transport.bpm.value * 10060);
      setTimeout(function () {
        e.clientX = 890 + _this7.left;
        e.clientY = 300 + _this7.top;
        if (_this7.looping) _this7.canvas.dispatchEvent(e);
      }, 150 / Tone.Transport.bpm.value * 14240);
      setTimeout(function () {
        e.clientX = 930 + _this7.left;
        e.clientY = 300 + _this7.top;
        if (_this7.looping) _this7.canvas.dispatchEvent(e);
      }, 150 / Tone.Transport.bpm.value * 17850);
      setTimeout(function () {
        e.clientX = 500 + _this7.left;
        e.clientY = 310 + _this7.top;
        if (_this7.looping) _this7.canvas.dispatchEvent(e);
      }, 150 / Tone.Transport.bpm.value * 20000);
      setTimeout(function () {
        e.clientX = 500 + _this7.left;
        e.clientY = 290 + _this7.top;
        if (_this7.looping) _this7.canvas.dispatchEvent(e);
      }, 150 / Tone.Transport.bpm.value * 23000);
      setTimeout(function () {
        e.clientX = 770 + _this7.left;
        e.clientY = 300 + _this7.top;
        if (_this7.looping) _this7.canvas.dispatchEvent(e);
      }, 150 / Tone.Transport.bpm.value * 25000);
      setTimeout(function () {
        e.clientX = 840 + _this7.left;
        e.clientY = 300 + _this7.top;
        if (_this7.looping) _this7.canvas.dispatchEvent(e);
    ...
    value: function toggleInstructions() {
      $('.inst-button').on('click', function (e) {
...
var Instrument = exports.Instrument = function () {
  ...
  _createClass(Instrument, [{
    ...
    value: function createDrums() {
      var drumSound = new Tone.MembraneSynth({
        pitchDecay: 0.09,
        octaves: 4,
        oscillator: {
          type: 'sine'
    ...
    value: function createKeyboard() {
      var keyboardSound = new Tone.Synth({
        volume: +5,
        oscillator: {
          type: 'triangle8'
        },
    ...
    key: 'createBass',
    value: function createBass() {
      var bassSound = new Tone.FMSynth({
        volume: +25,
        harmonicity: 3,
        modulationIndex: 3,
        detune: 0,
    ...
    key: 'drawKeyboard',
    value: function drawKeyboard(ctx) {
      ctx.strokeStyle = 'blue';
      ctx.fillStyle = 'yellow';
      ctx.lineWidth = 10;
      ctx.beginPath();
